...
const mergeWord = merge ("samen", "voegen");
...
const yourDog = calculateDogYears(5);
console.log(yourDog);
...
const outcome=wrapper("pepernoot","*");
console.log(outcome);
...
const detailString = createDetailString({ firstName: 'Maria', lastName: 'Klok', profession: 'teacher'});
